...
public class BombaDbContext : DbContext
{
    ...
    {
        var connectionString = Environment.GetEnvironmentVariable("CONNECTION_STRING") ?? "Host=localhost:5450;Database=bomba_db;Username=postgres;Password=yourpassword";
